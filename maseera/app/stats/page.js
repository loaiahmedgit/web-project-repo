    ...
    <div className={styles.container}>
      ...
      <div className={styles.summaryStrip}>
        <div className={styles.summaryInner}>
          ...
          <div className={styles.summaryItem}>
            <div className={styles.summaryValue}>{stats.totalReposts}</div>
            <div className={styles.summaryLabel}>Reposts</div>
          </div>
        </div>
      </div>
          ...
          {stats.mostLikedPost && (
            <div className={styles.featureCard}>
              ...
              <div className={styles.statMeta}>
                ...
                <div className={styles.metaItem}>
                  <span className={styles.metaValue}>{stats.mostLikedPost._count.reposts}</span>
                  <span className={styles.metaLabel}>Reposts</span>
                </div>
              </div>
            </div>
          )}
